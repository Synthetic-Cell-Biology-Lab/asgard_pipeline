...
annotation_files = {
    "profilin" :"/home/anirudh/asgard_pipeline/database/protein_sets/protein_ids/profilin.ids"
}
...
for annotation, file in annotation_files.items():
    ...
    with open(file) as f:
        protein_ids = set(line.strip().replace(" ", "_").upper() for line in f if line.strip())
